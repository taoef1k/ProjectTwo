...
/**
 * The base model interface for the CategoryArticles service. Represents a row in the &quot;AR_CategoryArticles&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.cxrus.model.impl.CategoryArticlesModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.cxrus.model.impl.CategoryArticlesImpl}.
 * </p>
 *
 * @author mohdtaufik
 ...
 * @generated
 */
public interface CategoryArticlesModel extends BaseModel<CategoryArticles>,
	GroupedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a category articles model instance should use the {@link CategoryArticles} interface instead.
	 */
	...
	@Override
	public CacheModel<com.cxrus.model.CategoryArticles> toCacheModel();
