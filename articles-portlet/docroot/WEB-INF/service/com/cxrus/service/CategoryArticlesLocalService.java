...
/**
 * Provides the local service interface for CategoryArticles. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author mohdtaufik
 * @see CategoryArticlesLocalServiceUtil
...
public interface CategoryArticlesLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CategoryArticlesLocalServiceUtil} to access the category articles local service. Add custom service methods to {@link com.cxrus.service.impl.CategoryArticlesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
